...
KETERANGAN_PEMBAYARAN = (
    'Untuk pembayaran bisa dilakukan melalui Bank jatim 0541007351 a.n Ahmad Muhlisin. '
    'Mohon konfirmasi apabila sudah melakukan pembayaran terimakasih'
)

INVOICE_LETTERHEAD = {
    'nama': 'Argopuro Walida',
    'kontak': '+62 857-0766-1006',
    'alamat': 'Ds. Tlogosari Rt 06/Rw 01, Kecamatan Sumbermalang, Kabupaten Situbondo',
    'judul': 'INVOICE PEMESANAN',
    'subjudul': 'Dokumen pembelian resmi — mohon periksa rincian berikut.',
    'footer': 'Argopuro Walida — Invoice pemesanan. Terima kasih atas kepercayaan Anda.',
}
